...
4. Скопировал файлы в локальный репозиторий ~/work/study/2023-2024/"Архитектура компьютера"/arch-pc/labs/lab04/ (@fig-015) и сохранил изменения на Github (@fig-016):
...
``` assembler
SECTION .data
	hello:      db "Matsyuk Konstantin",0xa 
	helloLen:   EQU $ - hello
SECTION .text
	global _start           
